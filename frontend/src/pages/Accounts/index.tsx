...
export function Accounts() {
  ...
  return (
    <div className="w-full pb-16 min-h-screen animate-fade-in">
      {/* Alinhamento visual preservado com px-1 */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {accounts.map((acc: AccountData) => {
              ...
              return (
                <div
                  key={acc.id}
                  className="card-default p-6 flex flex-col justify-between h-44 border-subtle/30 group hover:border-brand/40 transition-all duration-300"
                >
