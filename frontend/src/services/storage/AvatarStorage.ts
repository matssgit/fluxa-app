// frontend/src/services/storage/AvatarStorage.ts
...
export class AvatarStorage {
  ...
  /**
   * Intercepta a leitura. Se a etiqueta for local, puxa da memória. Senão, usa a URL real (ex: S3).
   */
  ...
  /**
   * Limpa o armazenamento (Útil para o Logout ou exclusão de conta)
   */
  static clear(): void {
