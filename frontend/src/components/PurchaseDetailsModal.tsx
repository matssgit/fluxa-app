...
import { useAccounts } from "../hooks/useAccounts"; // Importando as contas para o seletor
   ...
   const handleCancel = () => {
      if (
         ...
         cancelPurchase(purchase.id, {
            onSuccess: () => onClose(), // Fecha o modal após cancelar com sucesso
         });
      }
   };
            ...
            <div className="p-6 overflow-y-auto max-h-[65vh]">
               ...
               <div className="space-y-3">
                  {installments.map((inst) => {
                     // Se a compra está cancelada e a parcela estava pendente, mostramos ela como cancelada também
